...
public class CollectActivity extends BaseActivity implements SwipeRefreshLayout
    ...
    public void onItemLongClick(View v, int position) {
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                try {
                    db.delete(entity);
                    ToastUtil.ToastShort(CollectActivity.this, "删除成功");
                    loadData(STATE_LOAD_REFRESH);
                } catch (DbException e) {
                    e.printStackTrace();
                    ToastUtil.ToastShort(CollectActivity.this, "删除失败");
                }
